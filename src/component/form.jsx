                ...
                <div className="pdf">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>{item.nieghbour_additional_detail}</td>
                        </tr>
                    </table>
            ...
            {client && (<div className="form">
                ...
                <fieldset>
                    ...
                    <input
                        ...
                        value={client.tpc}
                        onChange={(e) => {
                            setClient({ ...client, tpc: e.target.value });
                            setUpdate({ ...update, tpc: e.target.value });
                        }}
                    />
                </fieldset>
                
                <fieldset>
                    <legend>Neighbour addtional detail</legend>
                    <input
                        type="text"
                        value={client.nieghbour_additional_detail}
                        onChange={(e) => {
                            setClient({ ...client, nieghbour_additional_detail: e.target.value });
                            setUpdate({ ...update, nieghbour_additional_detail: e.target.value });
                        }}
                    />
                </fieldset>
